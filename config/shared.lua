-- Luxury vendor will only be enabled if this resource is started (before this resource)
local LUXURY_MLO_RESOURCE_NAME = 'concessfreepatoche'
...
local CONFIG = {
    ...
    shops = {
        ...
        -- ====================================
        -- MLO Resource name: concessfreepatoche
        -- Update: Extracted this part out
...
if GetResourceState(LUXURY_MLO_RESOURCE_NAME) == "started" then
    CONFIG.shops.luxury = {
        type = 'managed',
        job = 'cardealer',
        zone = {
